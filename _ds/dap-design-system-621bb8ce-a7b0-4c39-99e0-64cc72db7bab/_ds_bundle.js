/* @ds-bundle: {"format":3,"namespace":"DAPDesignSystem_621bb8","components":[{"name":"Eyebrow","sourcePath":"components/brand/Eyebrow.jsx"},{"name":"HighlightBar","sourcePath":"components/brand/HighlightBar.jsx"},{"name":"Logo","sourcePath":"components/brand/Logo.jsx"},{"name":"StatBlock","sourcePath":"components/brand/StatBlock.jsx"},{"name":"Badge","sourcePath":"components/core/Badge.jsx"},{"name":"Button","sourcePath":"components/core/Button.jsx"},{"name":"Card","sourcePath":"components/core/Card.jsx"},{"name":"Tag","sourcePath":"components/core/Tag.jsx"},{"name":"Input","sourcePath":"components/forms/Input.jsx"}],"sourceHashes":{"components/brand/Eyebrow.jsx":"b8431fc27603","components/brand/HighlightBar.jsx":"f15eba0c095c","components/brand/Logo.jsx":"9dbd5b9bf34e","components/brand/StatBlock.jsx":"86a6625b6218","components/core/Badge.jsx":"708cd4debad1","components/core/Button.jsx":"eb33e10c9ccb","components/core/Card.jsx":"435c74be4af4","components/core/Tag.jsx":"48262c544d89","components/forms/Input.jsx":"c2ffbcdeda6d","tracking-electoral-2027/deck-stage.js":"0cc26af2402a"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.DAPDesignSystem_621bb8 = window.DAPDesignSystem_621bb8 || {});
...
/**
 * DAP Eyebrow — tracked uppercase label that sits above titles.
 */
function Eyebrow({
  children,
  tone = 'magenta',
  ...
  const colors = {
    magenta: 'var(--dap-magenta)',
    bright: 'var(--dap-magenta-bright)',
    ink: 'var(--dap-ink)',
  ...
  const base = {
    ...
    color: colors[tone] || colors.magenta,
    ...style
  };
...
// components/brand/HighlightBar.jsx
try { (() => {
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * DAP HighlightBar — solid knockout bar wrapping a run of text,
 * the "PARA EMPRESAS" device. Inline by default.
 */
function HighlightBar({
  ...
  const tones = {
    magenta: {
      background: 'var(--dap-magenta)',
      color: '#fff'
    },
    ink: {
      background: 'var(--dap-ink)',
      color: '#fff'
    },
    wine: {
      background: 'var(--dap-wine)',
      color: '#fff'
    }
  };
  const base = {
...
Object.assign(__ds_scope, { HighlightBar });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/brand/HighlightBar.jsx", error: String((e && e.message) || e) }); }

// components/brand/Logo.jsx
try { (() => {
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * DAP Logo — renders the packaged lockup image.
 * Pass `src` with the path to the copied asset; defaults assume an
 * `assets/` folder beside the consuming page.
 */
function Logo({
  variant = 'magenta',
  height = 44,
  src,
  alt = 'DAP — Despacho de Asuntos Públicos',
  style = {},
  ...rest
}) {
  const defaults = {
    magenta: 'assets/dap-logo-magenta-transparent.png',
    white: 'assets/dap-logo-white-transparent.png'
  };
  const resolved = src || defaults[variant] || defaults.magenta;
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * DAP StatBlock — the signature data rectangle.
 * Big display figure over a short supporting label, on a solid fill.
 */
function StatBlock({
  figure,
  label,
  ...
  }, figure), label && /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: 'var(--font-body)',
      fontSize: '13px',
      lineHeight: 1.4,
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * DAP Badge — small status indicator with a leading dot.
 */
function Badge({
  children,
  status = 'neutral',
  ...
  const map = {
    neutral: {
      fg: 'var(--dap-gray-700)',
      bg: 'var(--dap-gray-100)',
      dot: 'var(--dap-gray-500)'
    },
    active: {
      fg: 'var(--dap-magenta-700)',
      bg: 'var(--dap-magenta-100)',
      dot: 'var(--dap-magenta)'
    },
    success: {
      fg: '#0F5C3B',
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * DAP Button — sharp-cornered, brand-forward action.
 * Variants: primary (magenta), secondary (ink), outline, ghost.
 */
function Button({
  children,
  variant = 'primary',
  ...
  const variants = {
    primary: {
      background: 'var(--dap-magenta)',
      color: 'var(--dap-white)',
      border: '2px solid var(--dap-magenta)'
    },
    secondary: {
      background: 'var(--dap-ink)',
      color: 'var(--dap-white)',
      border: '2px solid var(--dap-ink)'
    },
    outline: {
...
function hoverFor(variant) {
  switch (variant) {
    case 'primary':
      return {
        background: 'var(--dap-magenta-700)',
        borderColor: 'var(--dap-magenta-700)'
      };
    case 'secondary':
      return {
        background: 'var(--dap-gray-800)',
        borderColor: 'var(--dap-gray-800)'
      };
    case 'outline':
      return {
        background: 'var(--dap-ink)',
    ...
    case 'ghost':
      return {
        background: 'var(--dap-magenta-100)'
      };
    default:
      return null;
  }
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * DAP Card — a sharp-cornered content container.
 * tone: surface color; bordered: hairline outline (for white tone).
 */
function Card({
  children,
  tone = 'white',
  ...
  const base = {
    ...
    borderRadius: 'var(--radius-card)',
    padding,
    border: bordered && (tone === 'white' || tone === 'subtle') ? '1px solid var(--border-subtle)' : '1px solid transparent',
    ...tones[tone],
    ...style
  };
  return /*#__PURE__*/React.createElement("div", _extends({
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * DAP Tag — compact label/chip for topics, parties, status.
 */
function Tag({
  children,
  tone = 'magenta',
  ...
  const tones = {
    ...
    outline: {
      background: 'transparent',
      color: 'var(--dap-ink)',
      boxShadow: 'inset 0 0 0 1.5px var(--dap-ink)'
    },
    tint: {
      background: 'var(--dap-magenta-100)',
      color: 'var(--dap-magenta-700)'
    }
  };
  const sizes = {
    sm: {
...
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
 * DAP Input — labelled text field with magenta focus underline.
 */
function Input({
  label,
  hint,
  ...
  const borderColor = error ? 'var(--dap-danger)' : focus ? 'var(--dap-magenta)' : 'var(--border-strong)';
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      fontSize: '14px',
      color: 'var(--text-strong)',
      background: disabled ? 'var(--dap-gray-50)' : 'var(--surface-page)',
      padding: '10px 12px',
      border: `1.5px solid ${borderColor}`,
      borderRadius: 'var(--radius-sm)',
      outline: 'none',
      boxShadow: focus && !error ? '0 0 0 3px var(--dap-magenta-100)' : 'none',
    ...
    style: {
      fontSize: '12px',
      marginTop: '6px',
      color: error ? 'var(--dap-danger)' : 'var(--text-muted)'
    }
  }, error || hint));
}
...
// tracking-electoral-2027/deck-stage.js
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "tracking-electoral-2027/deck-stage.js", error: String((e && e.message) || e) }); }

__ds_ns.Eyebrow = __ds_scope.Eyebrow;

__ds_ns.HighlightBar = __ds_scope.HighlightBar;
